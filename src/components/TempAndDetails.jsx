...
const TempAndDetails = ({weather:{details,iconUrl, temp, feels_like, speed, humidity, sunrise, sunset, temp_max, temp_min }, units }) => {
  ...
  return (
    <div className='w-[85%] mx-auto'>
          <div className={`flex items-center justify-center pt-2 text-xl ${theme==='dark'?'text-cyan-300':'text-white'}`}>
              <p >{details}</p>
          </div>
          ...
          <div className='flex flex-col sm:flex-row w-[170px] sm:w-full items-start mx-auto
